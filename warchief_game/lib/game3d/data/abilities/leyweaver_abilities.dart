...
/// Leyweaver/Support abilities - Healing and buff skills powered by Ley Line energy
class LeyweaverAbilities {
  LeyweaverAbilities._();
  ...
  /// Battle Blessing — Activates chain-combo mode for Leyweavers.
  /// Land 7 consecutive Leyweaver strikes within 7 seconds to fire the chain combo.
  static final battleBlessing = AbilityData(
    ...
    description: 'Bless your strikes with battle-light — activate chain-combo mode. '
        'Land 7 hits within 7 seconds to trigger a massive heal and regeneration burst.',
    type: AbilityType.melee,
    damage: 10.0,
    cooldown: 10.0,
    range: 2.0,
