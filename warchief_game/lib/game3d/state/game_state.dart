...
class GameState {
  ...
  double get maxWhiteMana => globalWindConfig?.whiteMaxMana ?? 100.0;
  ...
  void updateWindAndWhiteMana(double dt) {
    ...
    if (exposure >= shelterThresh) {
      // Wind is blowing — regenerate white mana
      final regenRate = (config?.windExposureRegen ?? 2.5) *
          exposure *
      ...
      // Sheltered — white mana decays (wind is fleeting)
